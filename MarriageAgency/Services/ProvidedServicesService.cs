...
namespace MarriageAgency.Services
{
    public class ProvidedServicesService
    {
        ...
        public List<ProvidedService> GetProvidedServices(int pageNumber, int pageSize, int employeeId = 0, int serviceId = 0, string userName = "all")
        {
            var providedServices = (from ps in db.ProvidedServices
                                    ...
                                    where (employeeId == 0 || e.Id == employeeId) && (serviceId == 0 || a.Id == serviceId) && (userName == "all" || u.UserName == userName)
        ...
        public int GetRowCount(int employeeId = 0, int serviceId = 0, string userName = "all")
        {
